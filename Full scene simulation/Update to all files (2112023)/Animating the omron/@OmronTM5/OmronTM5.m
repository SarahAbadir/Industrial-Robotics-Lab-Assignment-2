...
%% Create the robot model
        ...
        link(4) = Link('d',0.106,    'a',0,      'alpha',pi/2,'offset', 0 , 'qlim',[deg2rad(-180),deg2rad(180)]); %Not fixed link   
   % link(4) = Link('d',0.106,    'a',0,      'alpha',pi/2,'offset',-pi/2,'qlim',[deg2rad(-180),deg2rad(180)]); %Fixed u link        
