...
%% Create the robot model
        function CreateModel(self)   
            ...
            link(1) = Link('d',0.146,    'a',0,      'alpha',pi/2,'offset',0,'qlim',[deg2rad(-270),deg2rad(270)]);
            ...
            link(5) = Link('d',0.2192,   'a',0,      'alpha',-pi/2,'offset',0,'qlim',[deg2rad(-180),deg2rad(180)]);
            link(6) = Link('d',0.0996,     'a',0,      'alpha',0,'offset',0,'qlim',[deg2rad(-270),deg2rad(270)]);
